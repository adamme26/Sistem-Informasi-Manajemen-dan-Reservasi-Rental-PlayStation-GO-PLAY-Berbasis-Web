...
<div class="section">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        <div class="profile-layout" style="display: grid; grid-template-columns: 1fr 1.5fr; gap: 40px; align-items: start;">
            ...
            <div>
                <div style="display:flex; align-items:center; margin-bottom: 24px; min-height: 40px;">
                    <h1 style="font-size: 32px; font-weight: 800; margin: 0;">Profil</h1>
                </div>
            ...
            <div>
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 24px; min-height: 40px;">
                    <h2 style="font-size: 24px; font-weight: 800; color: white; margin: 0;">Riwayat & Pesanan Aktif</h2>
