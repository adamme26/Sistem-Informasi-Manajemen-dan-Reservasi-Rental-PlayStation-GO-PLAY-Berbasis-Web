...
<section class="section" style="padding-top: 40px;">
    ...
    <h2 class="section-title" data-aos="fade-up" style="font-size: 42px; font-weight: 800; margin-bottom: 60px; line-height: 1.2;">Pilih Unit &<br>Jadwal Bermain</h2>

    <div class="ps-cards-grid">
        {{-- PS5 Card --}}
        <div class="ps-card" data-aos="fade-up" data-aos-delay="100">
            <div class="ps-card-img">
                <img src="{{ asset('images/ps5.png?v=5') }}" alt="PlayStation 5">
            </div>
        ...
        {{-- PS4 Card --}}
        <div class="ps-card" data-aos="fade-up" data-aos-delay="200">
            <div class="ps-card-img">
                <img src="{{ asset('images/ps4.png?v=5') }}" alt="PlayStation 4">
            </div>
            <div class="ps-card-info">
...
<section class="section" style="padding-top: 40px;">
    ...
    <h2 class="section-title" data-aos="fade-up" style="font-size: 42px; font-weight: 800; margin-bottom: 60px; line-height: 1.2;">Cek Status<br>Unit Tersedia</h2>
    ...
    <div class="status-grid" style="max-width:1100px; margin:0 auto;">
        ...
        @php
            ...
            $isAvailable = !$activeBooking && !$isMaintenance;
        @endphp
        <div class="status-card" data-aos="fade-up" data-aos-delay="{{ $index * 50 }}">
            <div class="status-header">
                <span class="status-badge-new {{ $isAvailable ? 'available' : ($isMaintenance ? 'maintenance' : ($activeBooking->is_playing ? 'playing' : 'reserved')) }}" style="{{ $isMaintenance ? 'background: rgba(239, 68, 68, 0.15); color: #ef4444;' : ($activeBooking && $activeBooking->is_playing ? 'background: rgba(239, 68, 68, 0.15); color: #ef4444;' : '') }}">
                    {{ $isAvailable ? 'AVAILABLE' : ($isMaintenance ? 'MAINTENANCE' : ($activeBooking->is_playing ? 'PLAYING' : 'RESERVED')) }}
                </span>
            ...
            <div class="status-body">
                ...
                @elseif($isMaintenance)
                    <div class="status-title" style="color:#ef4444;">Maintenance</div>
                    <div class="status-desc">Sedang dalam perbaikan</div>
                @else
                    @if($activeBooking->is_playing)
                        <div class="status-title">Tidak Tersedia</div>
                        <div class="status-desc">Akan tersedia pukul {{ $console->availableAt ? \Carbon\Carbon::parse($console->availableAt)->format('H:i') : \Carbon\Carbon::parse($activeBooking->end_time)->format('H:i') }}</div>
                    @else
            ...
            <div class="status-action">
                ...
                @elseif($activeBooking && $activeBooking->is_playing)
                    <div class="btn-reserved-placeholder" style="background: rgba(239, 68, 68, 0.15); color: #ef4444; display: flex; align-items: center; justify-content: center; font-weight: 700; border: 1px solid rgba(239, 68, 68, 0.3); font-size: 14px; letter-spacing: 0.05em; text-transform: uppercase;">Sedang Bermain</div>
                @else
                    <div class="btn-reserved-placeholder" style="{{ $isMaintenance ? 'background: rgba(239, 68, 68, 0.15);' : '' }}"></div>
                @endif
            </div>
        </div>
        @endforeach
    ...
    <div style="max-width:1100px; margin: 40px auto 0;" data-aos="fade-up">
...
<section class="contact-section" style="padding-top: 60px; padding-bottom: 80px;">
    ...
    <h2 class="contact-title" data-aos="fade-up" style="font-size: 42px; font-weight: 800; margin-top: 60px; margin-bottom: 80px; line-height: 1.2;">Butuh Bantuan?<br>Hubungi Kami</h2>
    <div class="contact-grid" style="display: flex; justify-content: center; gap: 80px;">
        <div class="contact-item" data-aos="zoom-in" data-aos-delay="100" style="display: flex; align-items: center; gap: 24px;">
            ...
            <div style="text-align: left;">
                ...
                <div class="contact-item-value" style="font-size: 14px; color: #9CA3AF; line-height: 1.4; text-transform: uppercase; max-width: 280px;">
                    <a href="https://www.google.com/maps/place/GoPlay+Alesha+Store/@-6.5598508,107.7778493,17z/data=!4m6!3m5!1s0x2e693bc6a573ebf9:0xa85eda84a84bdd1e!8m2!3d-6.5598508!4d107.7793888!16s%2Fg%2F11yqx97s27?entry=ttu&g_ep=EgoyMDI2MDYwMS4wIKXMDSoASAFQAw%3D%3D" target="_blank" style="color: inherit; text-decoration: none; transition: color 0.3s ease;" onmouseover="this.style.color='white'" onmouseout="this.style.color='inherit'">
                        Jl. Kapten Hanafiah No.6444, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat 41211.
                    </a>
                </div>
            </div>
        </div>
        <div class="contact-item" data-aos="zoom-in" data-aos-delay="200" style="display: flex; align-items: center; gap: 24px;">
            ...
            <div style="text-align: left;">
                ...
                <div class="contact-item-value" style="font-size: 14px; color: #9CA3AF; text-transform: uppercase;">
                    <a href="https://www.instagram.com/goplay.sbg/" target="_blank" style="color: inherit; text-decoration: none; transition: color 0.3s ease;" onmouseover="this.style.color='white'" onmouseout="this.style.color='inherit'">
                        @goplay.sbg
                    </a>
                </div>
            </div>
