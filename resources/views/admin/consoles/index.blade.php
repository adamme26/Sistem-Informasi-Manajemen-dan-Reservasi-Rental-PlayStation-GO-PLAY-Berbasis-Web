...
<div class="admin-page">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2rem;">
        <div style="font-family:'Orbitron',sans-serif; font-size:1.5rem; font-weight:700;">Kelola Inventaris</div>
        <a href="{{ route('admin.consoles.create') }}" class="btn btn-primary">+ Tambah Inventaris</a>
    </div>
            ...
            <table class="gp-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="console-type-badge badge-ps4">{{ $console->kategori }}</span></td>
                        ...
                        <td>
                            <div style="display:flex; gap:0.5rem;">
                                ...
                                <form method="POST" action="{{ route('admin.consoles.destroy', $console) }}" onsubmit="return confirm('Apakah yakin untuk menghapus data unit ini?')">
                                    @csrf @method('DELETE')
