...
<div class="admin-header">
    <div>
        ...
        <div class="page-title">{{ isset($console) ? 'Edit Inventaris' : 'Tambah Inventaris Baru' }}</div>
    </div>
</div>
        ...
        <form method="POST"
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control" required>
                        <option value="PS4" {{ old('kategori', $console->kategori ?? '') === 'PS4' ? 'selected' : '' }}>PS4</option>
                        <option value="PS5" {{ old('kategori', $console->kategori ?? '') === 'PS5' ? 'selected' : '' }}>PS5</option>
                        <option value="VR" {{ old('kategori', $console->kategori ?? '') === 'VR' ? 'selected' : '' }}>VR</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div style="display:flex; gap:1rem; margin-top:1.5rem;">
                <button type="submit" class="btn btn-primary">
                    {{ isset($console) ? '💾 Simpan Perubahan' : '+ Tambah Inventaris' }}
                </button>
