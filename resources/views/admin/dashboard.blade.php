            ...
            <div>
                ...
                <div style="display:flex; align-items:center; gap:1rem; padding:1rem 1.5rem; border-bottom:1px solid var(--border);">
                    ...
                    <div style="text-align:right; flex-shrink:0;">
                        ...
                        <form method="POST" action="{{ route('admin.bookings.start-playing', $booking) }}" style="display:inline; margin-top:4px; display:block;">
                            @csrf
                            <button type="submit" class="btn btn-primary btn-sm" style="font-size:0.7rem; padding:4px 8px;">▶ Mulai</button>
                        </form>
                        @endif
                        @if($booking->is_playing)
                        <div style="margin-top:4px; font-size:0.8rem; font-family:'Orbitron',sans-serif; color:#ef4444; font-weight:bold;">
