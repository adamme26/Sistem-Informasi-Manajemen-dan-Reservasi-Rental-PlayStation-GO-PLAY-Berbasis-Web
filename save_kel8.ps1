...
$content = Read-DocxFull ".\kel8_copy.docx"
# Save to file so we can read it fully
[System.IO.File]::WriteAllText(".\kel8_content.txt", $content, [System.Text.Encoding]::UTF8)
Write-Output "Done. Lines: $($content.Split("`n").Count)"
