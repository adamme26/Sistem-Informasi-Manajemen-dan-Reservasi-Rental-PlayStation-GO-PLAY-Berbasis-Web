...
<head>
    ...
    <title>Admin Register | GOPLAY</title>
...
<body>
    <div class="admin-auth-box">
        <div class="admin-brand">
            ...
            <div class="logo-sub">ADMIN REGISTRATION</div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.register.store') }}">
            ...
            <button type="submit" class="btn btn-primary" style="width:100%; justify-content:center; margin-top:1rem;">Daftar sebagai Admin</button>
        </form>

        <div style="text-align:center; margin-top:1.5rem; font-size:0.875rem;">
            <a href="{{ route('admin.login') }}" style="color:var(--blue); text-decoration:none;">Sudah punya akun? Login Admin</a>
        </div>
    </div>
</body>
</html>
